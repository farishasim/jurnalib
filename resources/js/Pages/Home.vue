        ...
        <div class="w-3/4 max-w-4xl p-6 lg:p-8 mt-32">
            <div class="flex justify-center">
                <svg
                    ...
                    class="h-16 w-auto bg-gray-100 dark:bg-gray-900 fill-cyan-500"
                >
                    <path
            ...
            <div class="mt-16">
                <div class="flex space-x-2 items-center p-6 bg-white from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 focus:outline focus:outline-2 focus:outline-cyan-500">
                    <div
                        class="flex-shrink-0 w-14 h-14 bg-cyan-50 dark:bg-red-800/20 flex items-center justify-center rounded-full"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"

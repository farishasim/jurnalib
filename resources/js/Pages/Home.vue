...
<template>
    ...
    >
        ...
        <div class="w-3/4 max-w-4xl p-6 lg:p-8 mt-32">
            ...
            <div class="">
                <div class="p-4 flex bg-white rounded-lg shadow-2xl shadow-gray-500/20">
                    <div class="w-[90%]">
                        <h2 class=" text-xl font-medium">testaaaaa</h2>
                        <p>test</p>
                    </div>
                    <div class="w-1/6 grid place-items-center">
                        ...
                        <div class="flex mt-2 w-7/12 justify-center items-center aspect-square rounded-md bg-gradient-to-br from-blue-500 to-cyan-400">
                            <p class="text-white text-xl font-extrabold">Q2</p>
                        </div>
                    </div>
                    <div class="w-1/6 grid place-items-center">
                        <h3>Scopus:</h3>
                        <div class="flex mt-2 w-7/12 justify-center items-center aspect-square rounded-md bg-gradient-to-br from-blue-500 to-cyan-400">
                            <p class="text-white text-xl font-extrabold">999</p>
                        </div>
                    </div>
                </div>
            </div>
